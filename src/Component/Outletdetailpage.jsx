...
function outletDetailPage({ values, handleBlur, handleChange, touched, errors, brandNameRef }) {
                    ...
                    <div>
                        ...
                        <div className='OutletInputFields' >
                            ...
                            <div className='inputFields'>
                                <label>Designation</label>
                                <div className='errorcontainr'>
                                    <input name='role1' value={values.role1} onChange={handleChange} onBlur={handleBlur} placeholder='Enter Role here' />
                            ...
                            <div className='inputFields'>
                                <label>Mobile Number</label>
                                <div className='errorcontainr'>
                                    <input name='omob' maxLength={10} value={values.omob} onChange={handleChange} placeholder='Enter Owner Number' />
                        ...
                        <div className='OutletInputFields'>
                            <div className='inputFields'>
                                <label>Name</label>
                                <div className='errorcontainr'>
                                    <input name='name3' value={values.name3} onChange={handleChange} />
                            ...
                            <div className='inputFields'>
                                <label>Designation</label>
                                <div className='errorcontainr'>
                                    <input name='role2' value={values.role2} onChange={handleChange} />
                            ...
                            <div className='inputFields'>
                                <label>Mobile Number</label>
                                <div className='errorcontainr'>
                                    <input name='omob3' value={values.omob3} onChange={handleChange} />
                    ...
                    <div style={{ border: "0px solid blue", display: 'flex', flexDirection: 'column' }}>
                        ...
                        <div className='OutletInputFields'>
                            ...
                            <div className='inputFields'>
                                <label>Designation</label>
                                <div className='errorcontainr'>
                                    <input name='role1' value={values.role1} onChange={handleChange} placeholder='Enter Role here' />
                            ...
                            <div className='inputFields'>
                                <label>Email</label>
                                <div className='errorcontainr'>
                                    <input name='oemail' value={values.oemail} onChange={handleChange} placeholder='Enter Manger Email' />
                        ...
                        <div className='OutletInputFields'>
                            ...
                            <div className='inputFields'>
                                <label>Email</label>
                                <div className='errorcontainr'>
                                    <input name='email3' value={values.email3} onChange={handleChange} />
                        ...
                        <div className='MenuUploadContainerParent'>
                            <div className='MenuUploadContainer'>
                                ...
                                <div className="subDiv">
                                    ...
                                    <h6 id='menuFileName' style={{ fontSize: '17px', fontWeight: '500' }}> File name</h6>

                                </div>

                                <div className="subDiv">
                                    <h6 id='menuFileSize' style={{ fontSize: '17px', fontWeight: '500' }}> File size</h6>
                                </div>

                            </div>

                            <div className='menuButtons'>
                                <button className='btn1 eye'>
                                ...
                                <button type='button' className='btn1 upload' for="file-upload" onClick={() => document.getElementById('file-upload').click()} >
                                ...
                                <button className='btn1 dlt'>
                                    ...
                                    <input id="file-dlt" style={{ display: "none" }} name='file' type="file" onChange={handleFileDelete} />
