        ...
        <div className='parentContainer'>
          <div className='Container1'>
            <div className='Container2'>
              ...
              <input name='bankname' value={values.benName} onChange={handleChange}  placeholder='Please Enter Benificiary Name' />
            </div>
            <div className='Container2'>

              <label>  Beneficiary Account No.</label>
              <input name='bankaccountnum' value={values.bankaccountnum} onChange={handleChange}  placeholder='Please Enter Account No.' />
            </div>
          </div>
          <div className='Container1'>
            <div className='Container2' >
              ...
              <input name='userBankName' value={values.userBankName} onChange={handleChange}  placeholder='Please Enter Bank Name' />
            </div>
            <div className='Container2'>

              <label>  Beneficiary IFSC Code</label>
              <input name='ifsc' value={values.ifsc} onChange={handleChange}  placeholder='Please Enter IFSC Code' />
            </div>
          </div>
        ...
        <div>
          ...
          <div className='chequeUploadContainerParent'>
            ...
            <div className='chequeUploadContainer'>
              ...
              <div className='subDiv2'>
                <h6 id='chequeName' style={{ fontSize: '17px', fontWeight: '500' }}> cheque.png</h6>

              </div>

              <div className='subDiv2'>
                <h6  id='chequeSize' style={{ fontSize: '17px', fontWeight: '500' }}>25.05 KB</h6>
              </div>
